...
def test_blob():
    ...
    conversation_history = [
        {"role": "user", "parts": [{"text": "(System Memory of previous conversation: I felt happy today logging everything. The user was nice.)"}]},
        {"role": "model", "parts": [{"text": "Understood. The memory has been loaded. Let's start a fresh chat."}]},
        {"role": "user", "parts": [{"text": "Hi"}]},
        {"role": "model", "parts": [{"text": "Hey there! How are you?"}]},
        {"role": "user", "parts": [{"text": "Nothing much, just testing layered memories."}]}
    ]
